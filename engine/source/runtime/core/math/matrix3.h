    ...
    */
    ...
    public:
        ...
        */
        ...
        {
            memcpy(m_rows[0].ptr(), arr[0], 3 * sizeof(float));
            memcpy(m_rows[1].ptr(), arr[1], 3 * sizeof(float));
        ...
        Matrix3x3(float (&float_array)[9])
        {
            ...
            m_rows[1][0] = float_array[3];
            m_rows[1][1] = float_array[4];
            m_rows[1][2] = float_array[5];
            m_rows[2][0] = float_array[6];
            m_rows[2][1] = float_array[7];
        ...
        Matrix3x3(const Quaternion& q)
        {
            ...
            m_rows[0][0] = 1 - 2 * yy - 2 * zz;
            m_rows[0][1] = 2 * xy + 2 * zw;
            m_rows[0][2] = 2 * xz - 2 * yw;

            m_rows[1][0] = 2 * xy - 2 * zw;
            m_rows[1][1] = 1 - 2 * xx - 2 * zz;
            m_rows[1][2] = 2 * yz + 2 * xw;

            m_rows[2][0] = 2 * xz + 2 * yw;
            m_rows[2][1] = 2 * yz - 2 * xw;
        ...
        void toData(float (&float_array)[9]) const
        {
            ...
            float_array[3] = m_rows[1][0];
            float_array[4] = m_rows[1][1];
            float_array[5] = m_rows[1][2];
            float_array[6] = m_rows[2][0];
            float_array[7] = m_rows[2][1];
            float_array[8] = m_rows[2][2];
        }
        ...
        Vector3 getColumn(size_t col_index) const
        {
            ...
            return Vector3(m_rows[0][col_index], m_rows[1][col_index], m_rows[2][col_index]);
        }
        ...
        bool operator==(const Matrix3x3& rhs) const
        {
            for (size_t row_index = 0; row_index < 3; row_index++)
            {
                ...
                {
                    if (m_rows[row_index][col_index] != rhs.m_rows[row_index][col_index])
                        return false;
                }
            }
        ...
        Matrix3x3 operator+(const Matrix3x3& rhs) const
        {
            ...
            for (size_t row_index = 0; row_index < 3; row_index++)
            {
                for (size_t col_index = 0; col_index < 3; col_index++)
                {
                    sum.m_rows[row_index][col_index] = m_rows[row_index][col_index] + rhs.m_rows[row_index][col_index];
                }
            }
            return sum;
        }
        ...
        Matrix3x3 operator-(const Matrix3x3& rhs) const
        {
            ...
            for (size_t row_index = 0; row_index < 3; row_index++)
            {
                for (size_t col_index = 0; col_index < 3; col_index++)
                {
                    diff.m_rows[row_index][col_index] = m_rows[row_index][col_index] - rhs.m_rows[row_index][col_index];
                }
            }
            return diff;
        }
        ...
        Matrix3x3 operator-() const
        {
            ...
            {
                for (size_t col_index = 0; col_index < 3; col_index++)
                    neg[row_index][col_index] = -m_rows[row_index][col_index];
            }
            return neg;
        }
        ...
        bool inverse(Matrix3x3& inv_mat, float fTolerance = 1e-06) const
        {
            ...
            inv_mat[0][0] = m_rows[1][1] * m_rows[2][2] - m_rows[1][2] * m_rows[2][1];
            inv_mat[0][1] = m_rows[0][2] * m_rows[2][1] - m_rows[0][1] * m_rows[2][2];
            inv_mat[0][2] = m_rows[0][1] * m_rows[1][2] - m_rows[0][2] * m_rows[1][1];
            inv_mat[1][0] = m_rows[1][2] * m_rows[2][0] - m_rows[1][0] * m_rows[2][2];
            inv_mat[1][1] = m_rows[0][0] * m_rows[2][2] - m_rows[0][2] * m_rows[2][0];
            inv_mat[1][2] = m_rows[0][2] * m_rows[1][0] - m_rows[0][0] * m_rows[1][2];
            inv_mat[2][0] = m_rows[1][0] * m_rows[2][1] - m_rows[1][1] * m_rows[2][0];
            inv_mat[2][1] = m_rows[0][1] * m_rows[2][0] - m_rows[0][0] * m_rows[2][1];
            inv_mat[2][2] = m_rows[0][0] * m_rows[1][1] - m_rows[0][1] * m_rows[1][0];
        ...
        {
            float cofactor00 = m_rows[1][1] * m_rows[2][2] - m_rows[1][2] * m_rows[2][1];
            float cofactor10 = m_rows[1][2] * m_rows[2][0] - m_rows[1][0] * m_rows[2][2];
            float cofactor20 = m_rows[1][0] * m_rows[2][1] - m_rows[1][1] * m_rows[2][0];

            float det = m_rows[0][0] * cofactor00 + m_rows[0][1] * cofactor10 + m_rows[0][2] * cofactor20;
        ...
        static Matrix3x3 scale(const Vector3& scale)
        {
            ...
            mat.m_rows[0][0] = scale.x;
            mat.m_rows[1][1] = scale.y;
            mat.m_rows[2][2] = scale.z;
