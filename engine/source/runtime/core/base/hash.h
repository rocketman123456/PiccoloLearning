...
namespace Piccolo
{
    ...
    static inline uint64_t i16(const char* s) { return details::i16(s, 0); }
    static inline uint64_t i32(const char* s) { return details::i32(s, 0); }
    static inline uint64_t i64(const char* s) { return details::i64(s, 0); }
    static inline uint64_t u16(const char* s) { return details::u16(s, 0); }
    static inline uint64_t u32(const char* s) { return details::u32(s, 0); }
    static inline uint64_t u64(const char* s) { return details::u64(s, 0); }
    ...
    constexpr uint64_t operator"" _hash(const char* s, size_t) { return Piccolo::details::hasher<std::string>()(s); }
