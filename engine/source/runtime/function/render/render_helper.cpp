    ...
    Matrix4x4 calculate_directional_light_camera(RenderScene& scene, RenderCamera& camera)
    {
        ...
        BoundingBox scene_bounding_box;
        {
            ...
            for (const RenderEntity& entity : scene.m_render_entities)
            {
                ...
                BoundingBox mesh_bounding_box_world = bounding_box_transform(mesh_asset_bounding_box, entity.m_model_matrix);
        ...
        Matrix4x4 light_proj;
        {
            ...
            BoundingBox frustum_bounding_box_light_view = bounding_box_transform(frustum_bounding_box, light_view);
            BoundingBox scene_bounding_box_light_view   = bounding_box_transform(scene_bounding_box, light_view);
