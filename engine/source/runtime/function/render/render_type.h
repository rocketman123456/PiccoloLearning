...
#define RHI_FALSE false
    ...
    enum RHICommandBufferLevel : int32_t
    {
    ...
    enum RHISampleCountFlagBits : int32_t
    {
    ...
    enum RHIAttachmentLoadOp : int32_t
    {
    ...
    enum RHIAttachmentStoreOp : int32_t
    {
    ...
    enum RHIDescriptorType : int32_t
    {
    ...
    enum RHIPhysicalDeviceType : int32_t
    {
    ...
    enum RHIPrimitiveTopology : int32_t
    {
    ...
    enum RHISamplerAddressMode : int32_t
    {
    ...
    enum RHISamplerMipmapMode : int32_t
    {
    ...
    enum RHIShaderStageFlagBits : int32_t
    {
    ...
    enum RHIComponentSwizzle : int32_t
    {
    ...
    enum RHIVertexInputRate : int32_t
    {
